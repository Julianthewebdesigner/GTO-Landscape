...
const Hardscaping: React.FC = () => {
  ...
  const features = [
    {
      title: "Paver Patios",
      description: "Custom-designed paver patios that blend beauty with functionality. We use premium materials to create stunning outdoor living spaces that last for decades.",
      image: "/images/Hardscape.jpeg"
    },
    {
      title: "Retaining Walls",
      description: "Structurally sound retaining walls that prevent erosion while adding visual appeal. Expertly engineered to handle Pacific Northwest weather conditions.",
      image: "/images/Retaining Wall.jpeg"
    },
    {
      title: "Outdoor Kitchens",
      description: "Turn your backyard into an entertainer's paradise with a fully-equipped outdoor kitchen. From grills to countertops, we handle every detail.",
    ...
    <div className="relative min-h-screen font-sans selection:bg-primary selection:text-white bg-charcoal">
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-12 relative z-10 pt-48 sm:pt-48 md:pt-56 pb-24">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-offWhite/80 max-w-2xl mb-8 font-light leading-relaxed">
              From elegant paver patios to robust retaining walls, we craft hardscape features that combine artistry with engineering excellence.
            </p>
      ...
      <section className="py-16 md:py-24 bg-offWhite text-charcoal">
        <div className="container mx-auto px-4 sm:px-6 md:px-12">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-4">Our Hardscaping Services</h2>
            <p className="text-offWhite/60 tracking-[0.2em] uppercase text-xs sm:text-sm text-charcoal/60">Crafted with Precision</p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-primary text-white">
        <div className="container mx-auto px-4 sm:px-6 md:px-12 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-6">Ready to Start Your Project?</h2>
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-8">
            Contact us today for a free consultation and estimate. Let's bring your hardscaping vision to life.
          </p>
